      ...
      >
        ...
        <div className="flex-1 space-y-1">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            <strong className="text-foreground font-medium">2 candidates</strong> submitted by external agencies already exist in your talent pool. Estimated sourcing fee savings: <AIShimmer className="font-bold text-foreground inline-block">$12,000</AIShimmer>
          </p>
          <div className="pt-2">
            <Button 
              variant="outline" 
