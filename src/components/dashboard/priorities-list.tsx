            ...
            >
              ...
              <span
                className={cn(
                  ...
                  p.completed ? "line-through opacity-40" : "text-foreground"
                )}
              >
                {p.type === "ai-suggestion" && (
                  <Sparkles className="inline w-3 h-3 text-ai-amber mr-1 mb-0.5" />
                )}
                {p.text}
              </span>
              ...
              {/* Badge */}
              <Badge
                variant={urgencyBadgeVariant(p.urgency)}
