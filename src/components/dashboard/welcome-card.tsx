...
export function WelcomeCard() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 via-background to-ai-amber/5 border border-border p-6 md:p-8"
    >
      ...
      <div className="relative">
        ...
        <p className="mt-3 text-base text-muted-foreground leading-relaxed">
          ...
          <span className="inline-flex items-center gap-1">
            <span
              className="ai-shimmer font-bold"
